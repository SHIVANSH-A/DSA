...
int main() {
    ...
    int eventTime = 100;
    int k = 2;
    vector<int> startTime = {10, 30, 50, 70};
    vector<int> endTime = {20, 40, 60, 80};

    int result = sol.maxFreeTime(eventTime, k, startTime, endTime);
    cout << "Maximum free time in any " << k << " break(s): " << result << endl;
